...
export const IndustryData = [
...

  {
    ...
    tags: ["electricity", "light", "electronic", "cable", "wires", "light installation", "electric", "bulb", "cable renovation", "power"]
  },

  {
    ...
    tags: ["water", "pipes", "leaky pipe", "pipe", "toilet", "leaky construction", "wall", "sanitary", "bathroom", "drain"]
  },
...

  {
    ...
    tags: ["wall", "paint thinner", "water", "color", "paint", "wallpaper", "concrete", "renovation", "brush", "paintjob"]
  },

  {
    ...
    tags: ["wall", "bricks", "slate", "wood construction", "concrete", "floor", "seiling", "renovation", "outdoor wall", "stone"]
  },
]